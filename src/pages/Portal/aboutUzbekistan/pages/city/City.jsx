    ...
    <>
      <div className="city">
        ...
        <div className="city_body container">
          ...
          <Slider title="Другие туристические объекты в Ташкенте" />
        </div>
      </div>
    </>
  );
    ...
    return (
        <>
            <div className="city">
                <div className="city_hero">
                    <h2>Ташкент</h2>
                    <h1>Дом-музей <br/>Джахан-Отин Увайси</h1>
                    <div className="city_hero_line"/>
                </div>
                <div className="city_body container">
                    <div className="city_intro">
                    ...
                    <Slider title="Другие туристические объекты в Ташкенте" data={cardData} />
                </div>
            </div>
        </>
    )
