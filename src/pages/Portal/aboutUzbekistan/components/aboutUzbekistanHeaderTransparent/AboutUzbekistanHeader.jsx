...
import Logo from "../../../../../assets/images/LogoWhrite.svg";
...
import Eye from "../../../../../assets/images/EyeWhrite.png";
  ...
  return (
    <header className="about-uzbekistan-header">
      <div className="header_transparent">
        <div className="header_transparent_navbar">
          <Link to="/portal" className="header_transparent_navbar_left">
          ...
          <a href="/flag">
            <motion.img
              whileTap={{ scale: 0.6 }}
              src={Flag}
              className="header_transparent_navbar_flags"
              alt="flag"
            />
          </a>
          <a href="/coat">
          ...
          {/* <label className="header_transparent_navbar_search">
            <input
              ref={searchRef}
              type="text"
              className="header_transparent_navbar_search_inputs"
          ...
          <div className="header_transparent_navbar_language">
            <div
              className="header_transparent_navbar_language-wrapper"
              onClick={() => setactiveLang((el) => !el)}
            >
              <CiGlobe className="header_transparent_navbar_language-icon" />
              <span style={{ color: "white" }}>
                {languageList.find((lan) => lan.type === language)?.label}
              </span>
              <IoMdArrowDropdown className="header_transparent_navbar_language-iconArrow" />
            </div>
            <div
              className="header_transparent_navbar_language-bar"
          ...
          <button
            className="header_transparent_navbar_eye burger"
