...
const AboutUzbekistanHeader = () => {
  ...
  return (
    <div className="about-uzbekistan-header">
      <div className="container">
        <div className="about-uzbekistan-header__navbar">
          <div className="about-uzbekistan-header__navbar-left">
            <Link to="/">
              <img src={Logo} alt="logo" />
              <span>VATANDOSHLAR JAMOAT FONDI</span>
            </Link>
          </div>
          <div className="about-uzbekistan-header__navbar-phone">
            ...
            <a
              ...
              className="about-uzbekistan-header__navbar-phone_number"
            >
              {contactData?.phone}
            </a>
          </div>
          <div className="about-uzbekistan-header__navbar-email">
            ...
            <a
              ...
              className="about-uzbekistan-header__navbar-email_number"
            >
              {contactData?.email}
            </a>
          </div>
          ...
          <Link to="/flag" className="first-flag">
            <motion.img
              whileTap={{ scale: 0.6 }}
              src={Flag}
              className="about-uzbekistan-header__navbar-flags"
              alt="flag"
            />
          </Link>
          <Link to="/coat">
          ...
          <motion.button
            whileTap={{ scale: 0.6 }}
            className="about-uzbekistan-header__navbar-eye"
            onClick={() => grayScale()}
          >
          ...
          <div className="about-uzbekistan-header__lang">
            <div
              className="about-uzbekistan-header__lang-wrapper"
              onClick={() => setActiveLangBar((el) => !el)}
            >
              <CiGlobe className="about-uzbekistan-header__lang-icon" />
              <span>
                {languageList.find((lan) => lan.type === language).label}
              </span>
              <IoMdArrowDropdown className="about-uzbekistan-header__lang-iconArrow" />
            </div>
            <div
              className="about-uzbekistan-header__lang-bar"
          ...
          <motion.button
            whileTap={{ scale: 0.6 }}
            className="about-uzbekistan-header__navbar-cabinet"
          >
          ...
          <button
            className="about-uzbekistan-header__navbar-eye burger"
...
export default AboutUzbekistanHeader;
