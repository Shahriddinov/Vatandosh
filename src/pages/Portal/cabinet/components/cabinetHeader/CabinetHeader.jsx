  ...
  return (
    <div className="cabinet-header">
      <div className="cabinet-header__user-information">
        ...
        <div
          className={`cabinet-header__user ${
            rightBtnToggle ? "nonactive" : ""
          }`}
        >
      ...
      <div className="cabinet-header__right">
        <div
          className={`cabinet-header__right-buttons ${
            rightBtnToggle ? "active" : ""
          }`}
        >
        ...
        >
          <img src={rightBtnToggle ? CloseBtn : rightButtonOpenIcon} alt="" />
        </div>
      </div>
    </div>
  );
