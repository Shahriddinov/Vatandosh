  ...
  return (
    <div
      className={`group-message ${
        activeUser ? "group-message__block" : "group-message__none"
      }`}>
      {groupData && showGroupMessages ? (
        <div className="group-message__messages-header">
          <div className="group-message__left" onClick={handleClick1}>
      ...
      {showGroupMessages ? (
        <div className="group-message__messages-body" ref={messagesRef}>
          ...
          {activeGroup ? (
                  ...
                  message?.user_id !== user?.user_id?.id ? (
                    ...
                    <div
                      ...
                      <div className="group-message__sent-details">
                        <div className="group-message__delete-message">
                          <svg
                            width="24"
                            height="24"
                            viewBox="0 0 12 12"
            ...
            <p className="group-message__no-group">{t("selectStart")}</p>
          )}
          {messagesLoading && (
