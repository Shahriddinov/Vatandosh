                ...
                {Levels.map((item, index) => (
                    <div key={index} className="onlineTeachingBody_level_start" >
                        <div className="onlineTeachingBody_level_start_cardInfo" >
                            <div className="onlineTeachingBody_level_start_cardInfo_titles">{item.title}</div>
                            <div className="onlineTeachingBody_level_start_cardInfo_describtions">{item.text}</div>
                            <div className="onlineTeachingBody_level_start_cardInfo_sends">{item.send}</div>
                        </div>
                        <div className="onlineTeachingBody_level_start_cardInfo">
                            <img className="onlineTeachingBody_level_start_cardInfo_teacher" src={item.photos} alt=""/>
                        </div>
                    </div>
                ))}
            </div>
