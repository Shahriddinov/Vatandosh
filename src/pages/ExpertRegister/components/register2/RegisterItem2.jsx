...
export default function RegisterItem2({ activeBarItem }) {
  ...
  const [data2, setData2] = useState([{ id: 1, otm: "", faculti: "", job: "Yurist" }])
    ...
    <form className={activeBarItem !== 1 ? 'registeritem2 registeritem-scaleHidden' : 'registeritem2 registeritem-scaleActive'} onSubmit={handleSubmit}>
      <div className="registeritem2-wrapper registeritem-borderLeft">
        ...
        <div className="registeritem-form">
          ...
          <button className="registeritem-addForm" onClick={() => setData1(prev => ([...prev, { id: Date.now(), otm: "", faculti: "", job: "" }]))}><BsPlusCircleFill /></button>
          {
            data2.map(el => (
              <div key={el.id} className="registeritem2-form-otm">
                <label htmlFor="" className="registeritem-label">
                  ...
                  <div>
                    <input
                      ...
                      maxLength={30}
                      placeholder={"Kiriting"}
                      onChange={(e) => handleChangeX({ ...el, otm: e.target.value.trim() })}
                    />
                    <img src={pencil} alt="" />
                  </div>
                </label>
                  ...
                  <label htmlFor="" className="registeritem-label">
                    ...
                    <div>
                      <input
                        ...
                        maxLength={30}
                        placeholder={"Kiriting"}
                        onChange={(e) => handleChangeX({ ...el, faculti: e.target.value.trim() })}
                      />
                      <img src={pencil} alt="" />
                    </div>
                  </label>
          ...
          <button className="registeritem-addForm" onClick={() => setData2(prev => ([...prev, { id: Date.now(), otm: "", faculti: "", job: "" }]))}><BsPlusCircleFill /></button>
        </div>
      </div>
