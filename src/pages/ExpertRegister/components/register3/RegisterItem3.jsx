...
export default function RegisterItem3({ activeBarItem }) {
  const [data, setData] = useState([
    { id: 1, workCountry: "", workRegion: "", position:"", workSpace: "", checkBox:false, startAtWork:"",endAtWork:"" }
  ]);
  ...
  return (
    ...
    >
      <div className="registeritem3-wrapper registeritem-borderLeft">
          ...
          <div key={el.id} className="registeritem-form">
              ...
              <label htmlFor="" className="registeritem-label">
                ...
                <div>
                  ...
                  required
                    ...
                    onChange={(e) => handleChange({ ...el, workRegion: e.target.value.trim()})}
                  />
                </div>
              </label>
            </div>
            <label htmlFor="" className="registeritem-label">
              ...
              <div>
                ...
                required
                  ...
                  placeholder={"Kiriting"}
                  value={el.position}
                  onChange={(e) => handleChange({ ...el, position: e.target.value.trim()})}
                />
                <img src={pencil} alt="" />
              </div>
            </label>
            <label htmlFor="" className="registeritem-label">
              ...
              <div>
                ...
                required
                  ...
                  value={el.workSpace}
                  placeholder={"Kiriting"}
                  onChange={(e) => handleChange({ ...el, workSpace: e.target.value.trim()})}
                />
                <img src={pencil} alt="" />
              </div>
            </label>
            <div className="registeritem-checkbox">
              <Checkbox
                ...
                onChange={(e) => handleChange({ ...el, checkBox: !el.checkBox})}
                />
            ...
            <div className="registeritem-flexbox">
              <label htmlFor="" className="registeritem-label">
                ...
                <div>
                  ...
                  onChange={(e) => handleChange({ ...el, startAtWork: e.target.value.trim()})}
                  />
                </div>
              </label>
              <label htmlFor="" className="registeritem-label">
                ...
                <div>
                  ...
                  required
                    ...
                    placeholder={"Kiriting"}
                    value={el.endAtWork}
                  onChange={(e) => handleChange({ ...el, endAtWork: e.target.value.trim()})}
                  />
                </div>
              </label>
            </div>
        ...
        <button className="registeritem-addForm"
        onClick={() => setData(prev => ([...prev, { id: Date.now(), workCountry: "", workRegion: "", position:"", workSpace: "", checkBox:false, startAtWork:"",endAtWork:"" }]))}>
          <BsPlusCircleFill />
        </button>
        </div>
      </div>
