      ...
      <div className="participate__modal">
        ...
        >
          ...
          <div className="form__row">
            ...
            <FormControl>
              ...
              <Select
                ...
                required
              >
                <MenuItem value={t("projects_page.item2")}>
                  {t("projects_page.item2")}
                </MenuItem>
                <MenuItem value={t("projects_page.item3")}>
                  {t("projects_page.item3")}
                </MenuItem>
                <MenuItem value={t("projects_page.item4")}>
                  {t("projects_page.item4")}
                </MenuItem>
                <MenuItem value={t("projects_page.item5")}>
                  {t("projects_page.item5")}
                </MenuItem>
                <MenuItem value={t("projects_page.item6")}>
                  {t("projects_page.item6")}
                </MenuItem>
                <MenuItem value={t("projects_page.item7")}>
          ...
          <Dropzone onDrop={handleDrop}>
            {({ getRootProps, getInputProps }) => (
              ...
              >
                ...
                {formData.images.length === 0 && (
                  <img src={ImgIcon} alt="error" />
                )}
                {formData.images.length === 0 && (
                  <p>{t("projects_page.form_image")} </p>
                )}
              </div>
            )}
          </Dropzone>
          ...
          <div className="url__wrapper">
            ...
            />
            {inputs}
            <button className="add__url" type="button" onClick={handleAddInput}>
              <img src={AddIcon} alt="error" />
            </button>
          </div>
