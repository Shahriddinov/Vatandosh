    ...
    return (
        <div className='main-header'>
            ...
            <ul className="main-header__breadcrumb">
                {pagePath.slice(0, pagePath.length - 1).map((el) => (
                    <li className="main-header__breadcrumb_item" key={el.id}>
                        <Link className='site-main-header__breadcrumb_link' to={el.path}>{el.label}</Link>
                        <img src={arrowRight} alt="breadcrumb line" />
                    </li>
                ))}

                <li className="main-header__breadcrumb_item current_link" aria-current="page">
