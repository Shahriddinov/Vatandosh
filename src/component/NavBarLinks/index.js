...
export const NavBarLinks = () => {
  ...
  return [
    ...
    },
    {
      title: t("citizin"),
      links: [
        { title: t("citizin_items.item1"), url: "/compatriots/public-associations" },
        { title: t("citizin_items.item2"), url: "/category-shows" },
        { title: t("citizin_items.item3"), url: "/compatriots/public-association-events" }
      ]
    },
    {
      title: t("projects"),
    ...
    },
    {
      title: t("information"),
      links: [
        { title: t("information_items.item1"), url: "/" },
