            ...
            <div className="peaceful__container container">
                <div className="peaceful__inner">
                    <div className="peaceful__header">
                        <h3 className="peaceful__title section_title">{t("peacefulTitle")}</h3>
                        <div className="peaceful__header_end">
                            <button className="peaceful__header_btn">{t("allPeacefulBtn")}</button>
                            ...
                            >
                                {
                                    peacefulData.map(el => (
                                        <SwiperSlide key={el?.id} className='peaceful__slider-item' >
                                            <div className="peaceful__slider_card" style={{backgroundImage: `url(https://vatanparvarbackend.napaautomotive.uz/storage/${el?.image})`}}>
