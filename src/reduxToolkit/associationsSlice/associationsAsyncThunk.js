...
export const getAssociationsAbout = createAsyncThunk(
  "get/associationsAbout",
  async () => {
    return await axios.get(GET_ASSOCIATIONS_ABOUT).then((res) => res.data);
  }
);
