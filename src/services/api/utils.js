...
export const GET_EXPERT_SUGGESTIONS = `/suggestion/show-expert-suggestion`;
export const DELETE_EXPERT_SUGGESTIONS = `/suggestion/delete/`;
...
export const GET_EXPERT_ASSOCIATIONS = `/expert-association/get-all`;
export const GET_EXPERT_ASSOCIATIONS_DETAIL = `/expert-association/get-one/`;
...
export const SEND_EXPERT_SUGGESTION = `/suggestion/create`;
...
export const GET_EXPERT_SCIENTIFIC = `/scientificDegree/show-scientific-degree`;
export const DELETE_EXPERT_SCIENTIFIC = `/scientificDegree/delete/`;
export const SEND_EXPERT_ACTIVITY = `${portalBaseUrl}/expert/activity/create`; //DELETE_EXPERT_SUGGESTIONS
...
export const UPDATE_EXPERT_ACTIVITY = `${portalBaseUrl}/expert/update/`;
// Delete requests
